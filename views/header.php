...
<head>
    ...
    <link rel="shortcut icon" 
          href="https://github.com/KevinDaniel-S/TallerMecanicoWeb/blob/master/assets/favicon.ico" 
          type="image/x-icon">
...
<ul class="navbar-nav">
    <li class="nav-item active">
      <a class="navbar-brand" href="<?php echo constant('URL')?>/admin">Ir a Admin</a>
    </li>
    <li class="nav-item active">
